...
public class CorrectFlagSubmittedDto extends AbstractAuditPojoDto {
    ...
    public CorrectFlagSubmittedDto(){}

    public CorrectFlagSubmittedDto(long sandboxId, long trainingDefinitionId, long trainingInstanceId, long trainingRunId, String playerLogin, int totalScore, int actualScoreInLevel, long level, String flagContent) {
    ...
    public CorrectFlagSubmittedDto(long timestamp, String type, long gameTime, long sandboxId, long trainingDefinitionId, long trainingInstanceId, long trainingRunId, String playerLogin, int totalScore, int actualScoreInLevel, long level, String flagContent) {
