...
public class LevelCompletedDto extends AbstractAuditPojoDto {
    ...
    public LevelCompletedDto(){}

    public LevelCompletedDto(long sandboxId, long trainingDefinitionId, long trainingInstanceId, long trainingRunId, String playerLogin, int totalScore, int actualScoreInLevel, long level, LevelType levelType) {
    ...
    public LevelCompletedDto(long timestamp, String type, long gameTime, long sandboxId, long trainingDefinitionId, long trainingInstanceId, long trainingRunId, String playerLogin, int totalScore, int actualScoreInLevel, long level, LevelType levelType) {
