...
public class TrainingDefinitionServiceTest {
	...
	public void findAll() {
		...
		Page<TrainingDefinition> pr = trainingDefinitionService.findAll(predicate, PageRequest.of(0, 2));
	...
	public void createAssessmentLevel() {
		...
		Optional<AssessmentLevel> createdLevel =
				trainingDefinitionService.createAssessmentLevel(trainingDefinition2.getId(), newAssessmentLevel);
	...
	public void createAssessmentLevelAsFirstLevel() {
		...
		Optional<AssessmentLevel> createdLevel =
				trainingDefinitionService.createAssessmentLevel(definitionWithoutLevels.getId(), newAssessmentLevel);
