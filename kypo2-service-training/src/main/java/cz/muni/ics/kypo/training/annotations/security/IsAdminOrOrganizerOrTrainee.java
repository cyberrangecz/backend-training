...
/**
 * The custom annotation <i>@IsAdminOrOrganizerOrTrainee<i/>. All methods annotated with this annotation expect the user has a role <strong>ROLE_TRAINING_ADMINISTRATOR<strong/>
...
public @interface IsAdminOrOrganizerOrTrainee {
}
