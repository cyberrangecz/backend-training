...
public class TrainingDefinitionServiceImpl implements TrainingDefinitionService {
	...
	public Optional<TrainingDefinition> clone(Long id) throws ServiceLayerException, CannotBeUpdatedException {
		...
		try {
			TrainingDefinition trainingDefinition =
					findById(id).orElseThrow(() -> new ServiceLayerException("Training definition with id: " + id + ", not found"));
	...
	public void swapLeft(Long definitionId, Long levelId) throws ServiceLayerException, CannotBeUpdatedException {
		...
		TrainingDefinition trainingDefinition =
				findById(definitionId).orElseThrow(() -> new ServiceLayerException("Training definition with id: " + definitionId + ", not found"));
		if (!trainingDefinition.getState().equals(TDState.UNRELEASED))
			throw new CannotBeUpdatedException("Cant edit released or archived training definition");
		...
		while (!swapLevel.getId().equals(levelId)) {
			...
			swapLevel =
					abstractLevelRepository.findById(swapLevel.getNextLevel()).orElseThrow(() -> new ServiceLayerException("Level not found"));
		}
		AbstractLevel oneBefore =
				abstractLevelRepository.findById(oneBeforeId).orElseThrow(() -> new ServiceLayerException("Cant swap left first level"));
		...
		if (twoBeforeId != null) {
			AbstractLevel twoBefore =
					abstractLevelRepository.findById(twoBeforeId).orElseThrow(() -> new ServiceLayerException("Level not found"));
	...
	public void swapRight(Long definitionId, Long levelId) throws ServiceLayerException, CannotBeUpdatedException {
		...
		if (oneBeforeId != null) {
			AbstractLevel oneBefore =
					abstractLevelRepository.findById(oneBeforeId).orElseThrow(() -> new ServiceLayerException("Level not found"));
			oneBefore.setNextLevel(swapLevel.getNextLevel());
			updateLevel(oneBefore);
		}
		AbstractLevel nextLevel = abstractLevelRepository.findById(swapLevel.getNextLevel())
				.orElseThrow(() -> new ServiceLayerException("Cant swap right last level"));
	...
	public void delete(Long id) throws ServiceLayerException, CannotBeDeletedException {
		...
		try {
			...
			if (definition.getStartingLevel() != null) {
				...
				while (levelId != null) {
					AbstractLevel level = abstractLevelRepository.findById(levelId).orElseThrow(() -> new ServiceLayerException("Level not found"));
	...
	public void deleteOneLevel(Long definitionId, Long levelId) throws ServiceLayerException, CannotBeUpdatedException {
		...
		while (!level.getId().equals(levelId)) {
			...
			level = abstractLevelRepository.findById(level.getNextLevel()).orElseThrow(() -> new ServiceLayerException("Level not found"));
		}
		...
		if (trainingDefinition.getStartingLevel().equals(level.getId())) {
			...
			AbstractLevel oneBefore =
					abstractLevelRepository.findById(oneIdBefore).orElseThrow(() -> new ServiceLayerException("Level not found"));
	...
	@Override
	public Optional<GameLevel> createGameLevel(Long definitionId, GameLevel gameLevel)
			throws ServiceLayerException, CannotBeUpdatedException {
	...
	@Override
	public Optional<InfoLevel> createInfoLevel(Long definitionId, InfoLevel infoLevel)
			throws ServiceLayerException, CannotBeUpdatedException {
	...
	@Override
	public Optional<AssessmentLevel> createAssessmentLevel(Long definitionId, AssessmentLevel assessmentLevel)
			throws ServiceLayerException, CannotBeUpdatedException {
	...
	public List<AbstractLevel> findAllLevelsFromDefinition(Long id) {
		...
		while (levelId != null) {
			level = abstractLevelRepository.findById(levelId).orElseThrow(() -> new ServiceLayerException("Level not found"));
			levels.add(level);
			levelId = level.getNextLevel();
		}
		return levels;
	...
	private AbstractLevel findLastLevel(Long levelId) {
		...
		while (levelId != null) {
			lastLevel =
					abstractLevelRepository.findById(lastLevel.getNextLevel()).orElseThrow(() -> new ServiceLayerException("Level not found"));
			levelId = lastLevel.getNextLevel();
		}
		return lastLevel;
	}
	...
	private boolean findLevelInDefinition(TrainingDefinition definition, Long levelId) {
		...
		while (nextId != null && !found) {
			AbstractLevel nextLevel = abstractLevelRepository.findById(nextId).orElseThrow(() -> new ServiceLayerException("Level not found"));
	...
	private Long createLevels(Long id) {
		...
		while (id != null) {
			AbstractLevel nextLevel = abstractLevelRepository.findById(id).orElseThrow(() -> new ServiceLayerException("Level not found"));
