...
@NamedEntityGraphs({
      ...
      subgraphs = {
        @NamedSubgraph(
            ...
            attributeNodes = {
              ...
              @NamedAttributeNode(
                  value = "betaTestingGroup",
                  subgraph = "betaTestingGroup.organizers")
            }),
        @NamedSubgraph(
  ...
  @NamedEntityGraph(
      ...
      subgraphs = {
        @NamedSubgraph(
            name = "trainingDefinition.authors",
...
@NamedQueries({
  ...
  @NamedQuery(
      ...
      query =
          "SELECT ti FROM TrainingInstance ti "
  ...
  @NamedQuery(
      ...
      query = "SELECT ti FROM TrainingInstance ti " + "WHERE ti.poolId = :poolId"),
  @NamedQuery(
  ...
  @NamedQuery(
      ...
      query =
          "SELECT (COUNT(ti) > 0) FROM TrainingInstance ti WHERE ti.id = :instanceId AND ti.endTime < :currentTime")
})
public class TrainingInstance extends AbstractEntity<Long> {
  ...
  public Set<UserRef> getOrganizers() {
    return organizers != null ? Collections.unmodifiableSet(organizers) : null;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof TrainingInstance)) return false;
