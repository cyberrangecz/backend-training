...
public class TrainingRunRepositoryTest {
  ...
  public void findByIdWithLevel() {
    ...
    Optional<TrainingRun> optionalTrainingRun =
        trainingRunRepository.findByIdWithLevel(trainingRunId);
  ...
  public void findAllByParticipantRefLogin() {
    ...
    List<TrainingRun> trainingRuns =
        trainingRunRepository.findAllByParticipantRefId(1L, predicate, pageable).getContent();
    ...
    List<TrainingRun> trainingRuns =
        trainingRunRepository
            .findAllByTrainingDefinitionIdAndParticipantUserRefId(
                trainingDefinition.getId(), participantRef.getUserRefId(), pageable)
            .getContent();
  ...
  public void findAllByTrainingInstanceId() {
    ...
    List<TrainingRun> trainingRuns =
        trainingRunRepository
            .findAllByTrainingInstanceId(trainingInstance.getId(), pageable)
            .getContent();
    assertEquals(2, trainingRuns.size());
    assertTrue(trainingRuns.contains(trainingRun1));
    assertTrue(trainingRuns.contains(trainingRun2));
  ...
  public void findAllByTrainingDefinitionId() {
    ...
    List<TrainingRun> trainingRuns =
        trainingRunRepository
            .findAllByTrainingDefinitionId(trainingDefinition.getId(), pageable)
            .getContent();
    assertEquals(2, trainingRuns.size());
    assertTrue(trainingRuns.contains(trainingRun1));
    assertTrue(trainingRuns.contains(trainingRun2));
  ...
  public void deleteTrainingRunsByTrainingInstance() {
    ...
    Page<TrainingRun> trainingRunsAfterDelete =
        trainingRunRepository.findAllByTrainingInstanceId(trainingInstance.getId(), pageable);
  ...
  public void findAllActiveByTrainingInstanceId() {
    ...
    Page<TrainingRun> trainingRuns =
        trainingRunRepository.findAllActiveByTrainingInstanceId(trainingInstance.getId(), pageable);
  ...
  public void findAllInactiveByTrainingInstanceIdPaginationTest() {
    ...
    pageable = PageRequest.of(0, 1);
    Page<TrainingRun> trainingRuns =
        trainingRunRepository.findAllInactiveByTrainingInstanceId(
            trainingInstance.getId(), pageable);
    assertEquals(1, trainingRuns.getContent().size());
  ...
  public void findAllByTrainingDefinitionIdPaginationTest() {
    ...
    pageable = PageRequest.of(0, 1);
    Page<TrainingRun> trainingRuns =
        trainingRunRepository.findAllByTrainingDefinitionId(trainingDefinition.getId(), pageable);
    assertEquals(1, trainingRuns.getContent().size());
  ...
  public void findAllByParticipantRefIdPaginationTest() {
    ...
    Page<TrainingRun> trainingRuns =
        trainingRunRepository.findAllByParticipantRefId(
            participantRef.getUserRefId(), predicate, pageable);
    assertEquals(1, trainingRuns.getContent().size());
