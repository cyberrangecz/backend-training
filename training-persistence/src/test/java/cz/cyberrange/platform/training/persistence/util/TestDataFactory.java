...
public class TestDataFactory {
    ...
    private AssessmentLevelDTO assessmentLevelDTO = generateAssessmentLevelDTO("Assessment DTO", 100, 12, "DTO questions",
            "DTO instructions", cz.cyberrange.platform.training.api.enums.AssessmentType.TEST);
    ...
    private QuestionDTO freeFormQuestionDTO = generateQuestionDTO(0, 2, 5, cz.cyberrange.platform.training.api.enums.QuestionType.FFQ, "Text of free form questionDTO");
    private QuestionDTO multipleChoiceQuestionDTO = generateQuestionDTO(0, 2, 5, cz.cyberrange.platform.training.api.enums.QuestionType.MCQ, "Text of free form questionDTO");
    private QuestionDTO extendedMatchingItemsDTO = generateQuestionDTO(0, 2, 5, cz.cyberrange.platform.training.api.enums.QuestionType.EMI, "Text of free form questionDTO");
    ...
    private TrainingRunByIdDTO trainingRunByIdDTO = generateTrainingRunByIdDTO(LocalDateTime.now(Clock.systemUTC()).minusHours(2), LocalDateTime.now(Clock.systemUTC()).plusHours(2),
            "logReference1", cz.cyberrange.platform.training.api.enums.TRState.RUNNING, "5L");
    private TrainingRunDTO trainingRunDTO = generateTrainingRunDTO(LocalDateTime.now(Clock.systemUTC()).minusHours(9), LocalDateTime.now(Clock.systemUTC()).minusHours(5),
            "logReference1", cz.cyberrange.platform.training.api.enums.TRState.FINISHED, "7L", 7);
