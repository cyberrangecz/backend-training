...
public class TestDataFactory {
  ...
  private AssessmentLevel questionnaire =
      generateAssessmentLevel(
          "Questionnaire", 0, 15L, 2, "List of some instructions", AssessmentType.QUESTIONNAIRE);
  private AssessmentLevelUpdateDTO assessmentLevelUpdateDTO =
      generateAssessmentLevelUpdateDTO(
          "New Assessment Title",
          "New instructions",
          cz.cyberrange.platform.training.api.enums.AssessmentType.QUESTIONNAIRE,
          9);
  private AssessmentLevelImportDTO assessmentLevelImportDTO =
      generateAssessmentLevelImportDTO(
          "Assessment level import",
          15,
          "Questions import",
          "Instructions import",
          cz.cyberrange.platform.training.api.enums.AssessmentType.TEST);
  private AssessmentLevelDTO assessmentLevelDTO =
      generateAssessmentLevelDTO(
          "Assessment DTO",
          100,
          12,
          "DTO questions",
  ...
  private Question freeFormQuestion =
      generateQuestion(0, 2, 5, QuestionType.FFQ, "Text of free form question");
  private Question multipleChoiceQuestion =
      generateQuestion(0, 2, 5, QuestionType.MCQ, "Text of free form question");
  private Question extendedMatchingItems =
      generateQuestion(0, 2, 5, QuestionType.EMI, "Text of free form question");

  private QuestionDTO freeFormQuestionDTO =
      generateQuestionDTO(
          0,
          2,
          5,
          cz.cyberrange.platform.training.api.enums.QuestionType.FFQ,
          "Text of free form questionDTO");
  private QuestionDTO multipleChoiceQuestionDTO =
      generateQuestionDTO(
          0,
          2,
          5,
          cz.cyberrange.platform.training.api.enums.QuestionType.MCQ,
          "Text of free form questionDTO");
  private QuestionDTO extendedMatchingItemsDTO =
      generateQuestionDTO(
          0,
          2,
          5,
  ...
  private TrainingLevel penalizedLevel =
      generateTrainingLevel(
          "Penalized Training Level",
          100,
          20L,
          3,
          "SecretAnswer",
          "Content of penalized level",
          "Solution of penalized level",
          true,
          5);
  private TrainingLevel nonPenalizedLevel =
      generateTrainingLevel(
          "Non-Penalized Training Level",
          50,
          5L,
          4,
          "PublicAnswer",
          "Content of non-penalized level",
          "Solution of non-penalized level",
          false,
          99);
  private TrainingLevelUpdateDTO trainingLevelUpdateDTO =
      generateTrainingLevelUpdateDTO(
          "New Training Title", 99, "newAnswer", "New Content", "New solution", true, 66, 6);
  private TrainingLevelImportDTO trainingLevelImportDTO =
      generateTrainingLevelImportDTO(
          "Training level import",
          12,
          "ImportAnswer",
          "Game level import content",
          "import solution",
          true,
          9,
          100);
  ...
  private InfoLevelUpdateDTO infoLevelUpdateDTO =
      generateInfoLevelUpdateDTO("New Info Title", "New Info Content");
  private InfoLevelImportDTO infoLevelImportDTO =
      generateInfoLevelImportDTO("Info level import", 5, "Info level import content");
  ...
  private AccessLevel accessLevel =
      generateAccessLevel(
          ...
          "Local content information. Command: ./start.sh ${USER_ID} ${ACCESS_TOKEN} ${CENTRAL_SYSLOG_IP}.",
          "start-training");
  ...
  private BasicLevelInfoDTO basicInfoLevelInfoDTO =
      generateBasicLevelInfoDTO("Basic Info Level info", LevelType.INFO_LEVEL);
  ...
  private HintImportDTO hintImportDTO =
      generateHintImportDTO("Hint Import", "Hint import content", 50);

  private TrainingDefinition unreleasedDefinition =
      generateTrainingDefinition(
          ...
          "John Doe",
          LocalDateTime.now(Clock.systemUTC()).minusHours(1));
  private TrainingDefinition releasedDefinition =
      generateTrainingDefinition(
          "Released definition",
          ...
          "John Doe",
          LocalDateTime.now(Clock.systemUTC()).minusHours(5));
  private TrainingDefinition archivedDefinition =
      generateTrainingDefinition(
          "Archived definition",
          ...
          "Jane Doe",
          LocalDateTime.now(Clock.systemUTC()).minusHours(10));
  private TrainingDefinitionDTO unreleasedDefinitionDTO =
      generateTrainingDefinitionDTO(unreleasedDefinition);
  private TrainingDefinitionDTO releasedDefinitionDTO =
      generateTrainingDefinitionDTO(releasedDefinition);
  private TrainingDefinitionDTO archivedDefinitionDTO =
      generateTrainingDefinitionDTO(archivedDefinition);
  private TrainingDefinitionInfoDTO unreleasedDefinitionInfoDTO =
      generateTrainingDefinitionInfoDTO(unreleasedDefinition);
  private TrainingDefinitionInfoDTO releasedDefinitionInfoDTO =
      generateTrainingDefinitionInfoDTO(releasedDefinition);
  private TrainingDefinitionInfoDTO archivedDefinitionInfoDTO =
      generateTrainingDefinitionInfoDTO(archivedDefinition);
  private TrainingDefinitionCreateDTO trainingDefinitionCreateDTO =
      generateTrainingDefinitionCreateDTO(
          "Training definition create DTO",
  ...
  private TrainingDefinitionUpdateDTO trainingDefinitionUpdateDTO =
      generateTrainingDefinitionUpdateDTO(
          "Training definition updaet DTO",
  ...
  private ImportTrainingDefinitionDTO importTrainingDefinitionDTO =
      generateImportTrainingDefinitionDTO(
          "Imported definition",
  ...
  private TrainingDefinitionByIdDTO trainingDefinitionByIdDTO =
      generateTrainingDefinitionByIdDTO(
          ...
          false,
          20L,
          LocalDateTime.now(Clock.systemUTC()).minusHours(15),
          LocalDateTime.now(Clock.systemUTC()).minusHours(15));

  private TrainingInstance futureInstance =
      generateTrainingInstance(
          LocalDateTime.now(Clock.systemUTC()).plusHours(10),
          LocalDateTime.now(Clock.systemUTC()).plusHours(20),
          "Future Instance",
          1L,
          "future-1111");
  private TrainingInstance ongoingInstance =
      generateTrainingInstance(
          LocalDateTime.now(Clock.systemUTC()).minusHours(10),
          LocalDateTime.now(Clock.systemUTC()).plusHours(10),
          "Ongoing Instance",
          2L,
          "ongoing-2222");
  private TrainingInstance concludedInstance =
      generateTrainingInstance(
          LocalDateTime.now(Clock.systemUTC()).minusHours(20),
          LocalDateTime.now(Clock.systemUTC()).minusHours(5),
          "Concluded Instance",
          3L,
          "concluded-3333");
  private TrainingInstanceCreateDTO trainingInstanceCreateDTO =
      generateTrainingInstanceCreateDTO(
          LocalDateTime.now(Clock.systemUTC()).plusHours(15),
          LocalDateTime.now(Clock.systemUTC()).plusHours(22),
          "Create Instance",
          "create");
  private TrainingInstanceUpdateDTO trainingInstanceUpdateDTO =
      generateTrainingInstanceUpdateDTO(
          LocalDateTime.now(Clock.systemUTC()).plusHours(5),
          LocalDateTime.now(Clock.systemUTC()).plusHours(7),
          "Update Instance",
          "update");
  private TrainingInstanceDTO trainingInstanceDTO =
      generateTrainingInstanceDTO(
          LocalDateTime.now(Clock.systemUTC()).plusHours(11),
          LocalDateTime.now(Clock.systemUTC()).plusHours(22),
          "Instance DTO",
          "DTO-5555",
          10L);
  private TrainingInstanceArchiveDTO trainingInstanceArchiveDTO =
      generateTrainingInstanceArchiveDTO(
          LocalDateTime.now(Clock.systemUTC()).minusHours(20),
          LocalDateTime.now(Clock.systemUTC()).minusHours(10),
          "Archived instance",
          "archived-6666");

  private TrainingRun runningRun =
      generateTrainingRun(
          LocalDateTime.now(Clock.systemUTC()).minusHours(2),
          LocalDateTime.now(Clock.systemUTC()).plusHours(2),
          "logReference1",
          TRState.RUNNING,
          2,
          true,
          ...
          "2L",
          20);
  private TrainingRun finishedRun =
      generateTrainingRun(
          LocalDateTime.now(Clock.systemUTC()).minusHours(10),
          LocalDateTime.now(Clock.systemUTC()).minusHours(5),
          "logReference2",
          ...
          "4L",
          0);
  private TrainingRun archivedRun =
      generateTrainingRun(
          LocalDateTime.now(Clock.systemUTC()).minusHours(20),
          LocalDateTime.now(Clock.systemUTC()).minusHours(10),
          "logReference3",
  ...
  private TrainingRunByIdDTO trainingRunByIdDTO =
      generateTrainingRunByIdDTO(
          LocalDateTime.now(Clock.systemUTC()).minusHours(2),
          LocalDateTime.now(Clock.systemUTC()).plusHours(2),
          "logReference1",
          cz.cyberrange.platform.training.api.enums.TRState.RUNNING,
          "5L");
  private TrainingRunDTO trainingRunDTO =
      generateTrainingRunDTO(
          LocalDateTime.now(Clock.systemUTC()).minusHours(9),
          LocalDateTime.now(Clock.systemUTC()).minusHours(5),
          "logReference1",
          cz.cyberrange.platform.training.api.enums.TRState.FINISHED,
          "7L",
          7);
  private AccessedTrainingRunDTO accessedTrainingRunDTO =
      generateAccessedTrainingRunDTO(
          "Accessed run",
          LocalDateTime.now(Clock.systemUTC()).minusHours(8),
          LocalDateTime.now(Clock.systemUTC()).minusHours(4),
          5,
          6,
          Actions.RESUME);
  ...
  private UserRefDTO userRefDTO1 =
      generateUserRefDTO(
          ...
          null);
  private UserRefDTO userRefDTO2 =
      generateUserRefDTO(
          12L,
          "Peter Most",
          "Most",
          ...
          "https://oidc.provider.cz/oidc",
          null);
  private UserRefDTO userRefDTO3 =
      generateUserRefDTO(
          14L,
          "John Nevel",
          "Nevel",
          ...
          "https://oidc.provider.cz/oidc",
          null);
  private UserRefDTO userRefDTO4 =
      generateUserRefDTO(
          17L, "Ted Mosby", "Mosby", "Ted", "mail4@test.cz", "https://oidc.provider.cz/oidc", null);
  ...
  public List<ExtendedMatchingStatement> getExtendedMatchingStatements(
      int numberOfItems, String itemPrefix, Question question) {
    List<ExtendedMatchingStatement> extendedMatchingStatements = new ArrayList<>();
    for (int i = 0; i < numberOfItems; i++) {
      extendedMatchingStatements.add(
          generateExtendedMatchingStatement(i, itemPrefix + " " + i, question));
    }
    return extendedMatchingStatements;
  }

  public List<ExtendedMatchingOption> getExtendedMatchingOptions(
      int numberOfOptions, String optionPrefix, Question question) {
    List<ExtendedMatchingOption> extendedMatchingOptions = new ArrayList<>();
    for (int i = 0; i < numberOfOptions; i++) {
      extendedMatchingOptions.add(
          generateExtendedMatchingOption(i, optionPrefix + " " + i, question));
    }
    return extendedMatchingOptions;
  }

  public List<QuestionChoice> getQuestionChoices(
      int numberOfOptions, String choicePrefix, List<Boolean> correctness, Question question) {
    List<QuestionChoice> questionChoices = new ArrayList<>();
    for (int i = 0; i < numberOfOptions; i++) {
      questionChoices.add(
          generateQuestionChoice(i, choicePrefix + " " + i, correctness.get(i), question));
    }
  ...
  public List<ExtendedMatchingStatementDTO> getExtendedMatchingItemDTOs(
      int numberOfItems, String itemPrefix, List<Integer> optionsMapping) {
    List<ExtendedMatchingStatementDTO> extendedMatchingItems = new ArrayList<>();
    for (int i = 0; i < numberOfItems; i++) {
      extendedMatchingItems.add(
          generateExtendedMatchingItemDTO(i, itemPrefix + " " + i, optionsMapping.get(i)));
    }
    return extendedMatchingItems;
  }

  public List<ExtendedMatchingOptionDTO> getExtendedMatchingOptionDTOs(
      int numberOfOptions, String optionPrefix) {
  ...
  public List<QuestionChoiceDTO> getQuestionChoiceDTOs(
      int numberOfOptions, String choicePrefix, List<Boolean> correctness) {
  ...
  private AssessmentLevel generateAssessmentLevel(
      String title,
      int maxScore,
  ...
  private Question generateQuestion(
      int order, int penalty, int points, QuestionType questionType, String text) {
  ...
  private ExtendedMatchingOption generateExtendedMatchingOption(
      int optionOrder, String text, Question question) {
  ...
  private ExtendedMatchingStatement generateExtendedMatchingStatement(
      int itemOrder, String itemText, Question question) {
  ...
  private QuestionChoice generateQuestionChoice(
      int choiceOrder, String choiceText, boolean isCorrect, Question question) {
  ...
  private QuestionDTO generateQuestionDTO(
      int order,
      int penalty,
      int points,
      cz.cyberrange.platform.training.api.enums.QuestionType questionType,
      String text) {
  ...
  private ExtendedMatchingOptionDTO generateExtendedMatchingOptionDTO(
      int optionOrder, String text) {
  ...
  private ExtendedMatchingStatementDTO generateExtendedMatchingItemDTO(
      int itemOrder, String text, int correctOptionOrder) {
  ...
  private QuestionChoiceDTO generateQuestionChoiceDTO(
      int choiceOrder, String text, boolean isCorrect) {
  ...
  private TrainingLevel generateTrainingLevel(
      String title,
      int maxScore,
      long estimatedDuration,
      int order,
      ...
      String content,
      String solution,
      boolean solutionPenalized,
      int incorrectAnswerLimit) {
  ...
  private InfoLevel generateInfoLevel(
      String title, long estimatedDuration, int order, String content) {
  ...
  private AccessLevel generateAccessLevel(
      String title,
      long estimatedDuration,
      int order,
      String cloudContent,
  ...
  private TrainingDefinition generateTrainingDefinition(
      String title,
      String description,
  ...
  private TrainingDefinitionDTO generateTrainingDefinitionDTO(
  ...
  private TrainingDefinitionInfoDTO generateTrainingDefinitionInfoDTO(
      TrainingDefinition trainingDefinition) {
  ...
  private TrainingInstance generateTrainingInstance(
    ...
    newTrainingInstance.setLastEditedBy("crczp-user");
    return newTrainingInstance;
  }

  private TrainingRun generateTrainingRun(
      LocalDateTime startTime,
      LocalDateTime endTime,
      String eventLogReference,
      TRState state,
      int incorrectAnswerCount,
      boolean solutionTaken,
      String SBIRefId,
      Integer SBIAllocId,
      int totalTrainingScore,
      int totalAssessmentScore,
      int maxScore,
      boolean levelAnswered,
      String previousSBIRefId,
      int currentPenalty) {
  ...
  private TrainingDefinitionCreateDTO generateTrainingDefinitionCreateDTO(
      String title,
      String description,
      String[] prerequisites,
      String[] outcomes,
  ...
  private TrainingDefinitionUpdateDTO generateTrainingDefinitionUpdateDTO(
      String title,
      String description,
      String[] prerequisites,
      String[] outcomes,
  ...
  private TrainingInstanceCreateDTO generateTrainingInstanceCreateDTO(
      LocalDateTime startTime, LocalDateTime endTime, String title, String accessToken) {
  ...
  private TrainingInstanceUpdateDTO generateTrainingInstanceUpdateDTO(
      LocalDateTime startTime, LocalDateTime endTime, String title, String accessToken) {
  ...
  private TrainingLevelUpdateDTO generateTrainingLevelUpdateDTO(
      String title,
      int maxScore,
      String answer,
      String content,
  ...
  private AssessmentLevelUpdateDTO generateAssessmentLevelUpdateDTO(
      String title,
      String instructions,
  ...
  private InfoLevelImportDTO generateInfoLevelImportDTO(
      String title, Integer estimatedDuration, String content) {
  ...
  private AssessmentLevelImportDTO generateAssessmentLevelImportDTO(
      String title,
  ...
  private TrainingLevelImportDTO generateTrainingLevelImportDTO(
      String title,
      Integer estimatedDuration,
      String answer,
      String content,
  ...
  private TrainingInstanceDTO generateTrainingInstanceDTO(
      LocalDateTime start, LocalDateTime end, String title, String accessToken, Long poolId) {
  ...
  private TrainingRunByIdDTO generateTrainingRunByIdDTO(
      LocalDateTime start,
      LocalDateTime end,
      String logReference,
      cz.cyberrange.platform.training.api.enums.TRState state,
      String SBIId) {
  ...
  private TrainingRunDTO generateTrainingRunDTO(
      LocalDateTime start,
      LocalDateTime end,
      String logReference,
      cz.cyberrange.platform.training.api.enums.TRState state,
  ...
  private AssessmentLevelDTO generateAssessmentLevelDTO(
      String title,
      int maxScore,
      int estimatedDuration,
      String questions,
      String instructions,
      cz.cyberrange.platform.training.api.enums.AssessmentType assessmentType) {
  ...
  private TrainingLevelDTO generateTrainingLevelDTO(
      String answer,
      String content,
      String solution,
      boolean solutionPenalized,
  ...
  private AccessedTrainingRunDTO generateAccessedTrainingRunDTO(
      String title,
      LocalDateTime start,
      LocalDateTime end,
  ...
  private TrainingInstanceArchiveDTO generateTrainingInstanceArchiveDTO(
      LocalDateTime start, LocalDateTime end, String title, String accessToken) {
  ...
  private PoolInfoDTO generatePoolInfoDTO(
      Long id, Long definitionId, Long lockId, Long maxSize, Long size, String sha, String revSha) {
  ...
  private SandboxPoolInfo generateSandboxPoolInfo(
      Long id, Long definitionId, Long maxSize, Long size) {
  ...
  private UserRefDTO generateUserRefDTO(
      Long userRefId,
      String fullName,
      String familyName,
      String givenName,
