...
public class BetaTestingGroupRepositoryTest {
  ...
  @Autowired private BetaTestingGroupRepository viewGroupRepository;
  ...
  public void findById() {
    Optional<BetaTestingGroup> betaTestingGroupOptional =
        viewGroupRepository.findById(viewGroup2.getId());
    assertTrue(betaTestingGroupOptional.isPresent());
    assertEquals(viewGroup2, betaTestingGroupOptional.get());

    Optional<BetaTestingGroup> tdViewGroupOptional2 =
        viewGroupRepository.findById(viewGroup1.getId());
