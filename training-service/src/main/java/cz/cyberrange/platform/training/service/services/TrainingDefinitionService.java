...
public class TrainingDefinitionService {
  ...
  /**
   * Find all Training Definitions by author if user is designer or all Training Definitions if user
   * is admin.
   *
   ...
   * @throws EntityNotFoundException training definition or level is not found.
   * @throws EntityConflictException level cannot be deleted in released or archived training
   *     definition.
   */
    ...
    if (abstractLevelToDelete.isPresent()) {
      trainingDefinition.setEstimatedDuration(
          trainingDefinition.getEstimatedDuration()
              - abstractLevelToDelete.get().getEstimatedDuration());
   ...
   * @throws EntityConflictException level cannot be updated in released or archived training
   *     definition.
   */
   ...
   * @throws EntityNotFoundException training definition is not found.
   * @throws EntityConflictException level cannot be created in released or archived training
   *     definition.
   */
  ...
  /**
   * Switch development state of definition from unreleased to released, or from released to
   * archived or back to unreleased.
   *
  ...
  public boolean hasReferenceSolution(Long trainingDefinitionId) {
    if (!trainingDefinitionRepository.existsById(trainingDefinitionId)) {
      throw new EntityNotFoundException(
          new EntityErrorDetail(TrainingDefinition.class, "id", Long.class, trainingDefinitionId));
    }
