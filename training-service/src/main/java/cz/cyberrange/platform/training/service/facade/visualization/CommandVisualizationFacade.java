...
public class CommandVisualizationFacade {
  ...
  public Object getReferenceGraphByInstanceId(Long instanceId) {
    ...
    return trainingFeedbackApiService.getReferenceGraph(
  ...
  public Object getAggregatedCommandsForOrganizer(
      Long instanceId, List<Long> runIds, boolean correct, List<MistakeType> mistakeTypes) {
    if (correct) {
  ...
  public List<CommandDTO> getAllCommandsByTrainingRun(Long runId) {
    ...
    if (trainingInstance.isLocalEnvironment()) {
      ...
      elasticCommands =
          opensearchApiService.findAllConsoleCommandsByAccessTokenAndUserId(accessToken, userId);
    } else {
      String sandboxId =
  ...
  private List<CommandDTO> openSearchCommandsToCommandDTOlist(
      List<Map<String, Object>> elasticCommands, LocalDateTime runStartTime) {
  ...
  private CommandDTO openSearchCommandToCommandDTO(
      OpenSearchCommand elasticSearchCommand, LocalDateTime runStartTime) {
