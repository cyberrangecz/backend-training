...
public class TrainingRunFacade {
  ...
  public void deleteTrainingRuns(List<Long> trainingRunIds, boolean forceDelete) {
    ...
    for (Long trainingRunId : trainingRunIds) {
      trainingInstance =
          trainingRunService
              .deleteTrainingRun(trainingRunId, forceDelete, true)
              .getTrainingInstance();
    ...
    trainingFeedbackApiService.createSummaryGraph(
        trainingInstance.getTrainingDefinition().getId(), trainingInstance.getId());
  }
  ...
  public void deleteTrainingRun(Long trainingRunId, boolean forceDelete) {
    TrainingRun deletedTrainingRun =
    ...
    trainingFeedbackApiService.deleteSummaryGraph(trainingInstance.getId());
    trainingFeedbackApiService.createSummaryGraph(
        trainingDefinition.getId(), trainingInstance.getId());
  }
  ...
  @IsTrainee
  @TransactionalRO
  public PageResultResource<TrainingRunDTO> findAllByTrainingDefinition(
      Long trainingDefinitionId, Pageable pageable) {
    Page<TrainingRun> trainingRuns =
        trainingRunService.findAllByTrainingDefinition(trainingDefinitionId, pageable);
    PageResultResource<TrainingRunDTO> trainingRunDTOPageResultResource =
        trainingRunMapper.mapToPageResultResource(trainingRuns);
    addParticipantsToTrainingRunDTOs(trainingRunDTOPageResultResource.getContent());
    return trainingRunDTOPageResultResource;
  ...
  private void createTraineeGraphAndUpdateSummaryGraph(TrainingRun run) {
    ...
    for (TrainingLevel level :
        this.trainingDefinitionService.getAllTrainingLevels(definition.getId())) {
    ...
    if (isAnyReferenceSolution) {
      this.trainingFeedbackApiService.createTraineeGraph(
          definition.getId(),
          instance.getId(),
          run.getId(),
          referenceSolution,
          run.getTrainingInstance().isLocalEnvironment()
  ...
  private TrainingType fromModelTrainingType(
      cz.cyberrange.platform.training.persistence.model.enums.TrainingType trainingType) {
