...
public class TrainingFeedbackApiService {
   ...
   */
  public TrainingFeedbackApiService(
      WebClient trainingFeedbackServiceWebClient, ObjectMapper objectMapper) {
   ...
   * @throws MicroserviceApiException error with specific message when calling training feedback
   *     microservice.
   */
  public void createReferenceGraph(
      Long definitionId, List<LevelReferenceSolutionDTO> levelReferenceSolutionDefinitions) {
    try {
      trainingFeedbackServiceWebClient
          .post()
          .uri("/graphs/training-definitions/{definitionId}", definitionId)
          .body(
              Mono.just(objectMapper.writeValueAsString(levelReferenceSolutionDefinitions)),
              String.class)
          .retrieve()
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to create reference graph for definition (ID: "
              + definitionId
              + ").",
          ex);
    }
   ...
   *     microservice.
   */
  public void createTraineeGraph(
      Long definitionId,
      Long instanceId,
      Long runId,
      List<LevelReferenceSolutionDTO> referenceSolution,
      String accessToken) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to create trainee graph for run (ID: "
              + runId
              + ").",
          ex);
    }
  ...
  public void createSummaryGraph(Long definitionId, Long instanceId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to create summary graph for the training instance (ID: "
              + instanceId
              + ").",
          ex);
    }
  ...
  public Object getReferenceGraph(Long definitionId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to get reference graph for definition (ID: "
              + definitionId
              + ").",
          ex);
    }
  ...
  public Object getTraineeGraph(Long runId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to get trainee graph for run (ID: "
              + runId
              + ").",
          ex);
    }
  ...
  public Object getSummaryGraph(Long instanceId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to get summary graph for training instance (ID: "
              + instanceId
              + ").",
          ex);
    }
  ...
  public Object getAggregatedCorrectCommands(List<Long> runIds) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to get correct commands for training runs (IDs: "
              + runIds
              + ").",
          ex);
    }
  ...
  /**
   * Get aggregated incorrect commands of the specific mistake types entered during the given
   * training runs.
   *
   * @param runIds ids of the training runs
    ...
    try {
      return trainingFeedbackServiceWebClient
          ...
          .uri(
              uriBuilder ->
                  uriBuilder
                      .path("/commands/incorrect")
                      .queryParam("runIds", StringUtils.collectionToDelimitedString(runIds, ","))
                      .queryParam(
                          "mistakeTypes",
                          StringUtils.collectionToDelimitedString(mistakeTypes, ","))
                      .build())
          .retrieve()
          .bodyToMono(Object.class)
          .block();
  ...
  public Object getAllCommandsByTrainingRun(Long runId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling Training Feedback API to get all commands for training run (ID: "
              + runId
              + ").",
          ex);
    }
  ...
  public void deleteReferenceGraph(Long definitionId) {
    try {
      ...
      if (ex.getStatusCode() != HttpStatus.NOT_FOUND) {
        throw new MicroserviceApiException(
            "Error when calling Training Feedback API to delete reference graph for training definition (ID: "
                + definitionId
                + ").",
            ex);
      }
  ...
  public void deleteSummaryGraph(Long instanceId) {
    try {
      ...
      if (ex.getStatusCode() != HttpStatus.NOT_FOUND) {
        throw new MicroserviceApiException(
            "Error when calling Training Feedback API to delete summary graph for training instance (ID: "
                + instanceId
                + ").",
            ex);
      }
  ...
  public void deleteTraineeGraph(Long runId) {
    try {
      ...
      if (ex.getStatusCode() != HttpStatus.NOT_FOUND) {
        throw new MicroserviceApiException(
            "Error when calling Training Feedback API to delete trainee graph for training run (ID: "
                + runId
                + ").",
            ex);
      }
  ...
  public void deleteAllGraphsByTrainingInstance(Long instanceId) {
    try {
      ...
      if (ex.getStatusCode() != HttpStatus.NOT_FOUND) {
        throw new MicroserviceApiException(
            "Error when calling Training Feedback API to delete all graphs created for training instance (ID: "
                + instanceId
                + ").",
            ex);
      }
