...
public class AuditEventsService {
  ...
  public void auditCorrectPasskeySubmittedAction(TrainingRun trainingRun, String passkey) {
    CorrectPasskeySubmitted.CorrectPasskeySubmittedBuilder<?, ?> correctPasskeySubmittedBuilder =
        (CorrectPasskeySubmitted.CorrectPasskeySubmittedBuilder<?, ?>)
            fillInCommonBuilderFields(trainingRun, CorrectPasskeySubmitted.builder());

    CorrectPasskeySubmitted correctPasskeySubmitted =
        correctPasskeySubmittedBuilder.passkeyContent(passkey).build();
  ...
  public void auditWrongPasskeySubmittedAction(TrainingRun trainingRun, String passkey) {
    WrongPasskeySubmitted.WrongPasskeySubmittedBuilder<?, ?> wrongPasskeySubmittedBuilder =
        (WrongPasskeySubmitted.WrongPasskeySubmittedBuilder<?, ?>)
            fillInCommonBuilderFields(trainingRun, WrongPasskeySubmitted.builder());

    WrongPasskeySubmitted wrongPasskeySubmitted =
        wrongPasskeySubmittedBuilder.passkeyContent(passkey).build();
  ...
  public void auditAssessmentAnswersAction(TrainingRun trainingRun, String answers) {
    AssessmentAnswers.AssessmentAnswersBuilder<?, ?> assessmentAnswersBuilder =
        (AssessmentAnswers.AssessmentAnswersBuilder<?, ?>)
            fillInCommonBuilderFields(trainingRun, AssessmentAnswers.builder());

    AssessmentAnswers assessmentAnswers = assessmentAnswersBuilder.answers(answers).build();
  ...
  public void auditTrainingRunEndedAction(TrainingRun trainingRun) {
    TrainingRunEnded.TrainingRunEndedBuilder<?, ?> trainingRunEndedBuilder =
        (TrainingRunEnded.TrainingRunEndedBuilder<?, ?>)
            fillInCommonBuilderFields(trainingRun, TrainingRunEnded.builder());

    TrainingRunEnded trainingRunEnded =
