...
import cz.cyberrange.platform.training.api.dto.visualization.progress.LevelProgress;
import cz.cyberrange.platform.training.api.dto.visualization.progress.PlayerProgress;
...
public class VisualizationFacade {
    ...
    private TableLevelDTO mapToTableLevelDTO(AbstractLevel abstractLevel, List<AbstractAuditPOJO> levelEvents) {
        ...
        if (abstractLevel instanceof TrainingLevel) {
            tableLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.TRAINING_LEVEL);
            countHintsTakenAndWrongAnswers(tableLevelBuilder, levelEvents);
        } else if (abstractLevel instanceof AssessmentLevel) {
            tableLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.ASSESSMENT_LEVEL);
    ...
    private ClusteringLevelDTO mapToLevelResultDTO(AbstractLevel abstractLevel,
        ...
        if (abstractLevel instanceof TrainingLevel) {
            clusteringLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.TRAINING_LEVEL);
        } else if (abstractLevel instanceof InfoLevel) {
            clusteringLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.INFO_LEVEL);
        } else if (abstractLevel instanceof AssessmentLevel) {
            clusteringLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.ASSESSMENT_LEVEL);
        } else if (abstractLevel instanceof AccessLevel) {
            clusteringLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.ACCESS_LEVEL);
        }
    ...
    private ProcessedLevelsData getProcessedLevelsData(List<AbstractLevel> levels, Map.Entry<Long, Map<Long, List<AbstractAuditPOJO>>> userEvents) {
        ...
        for (AbstractLevel abstractLevel : levels) {
            ...
            if (abstractLevel instanceof TrainingLevel) {
                timelineLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.TRAINING_LEVEL)
                        .order(abstractLevel.getOrder())
                        .correctAnswerTime(processedEventsData.correctAnswerTime)
                        .solutionDisplayedTime(processedEventsData.solutionDisplayedTime);
            } else if (abstractLevel instanceof InfoLevel) {
                timelineLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.INFO_LEVEL);
            } else if (abstractLevel instanceof AccessLevel) {
                timelineLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.ACCESS_LEVEL);
            } else {
                timelineLevelBuilder.levelType(cz.cyberrange.platform.training.api.enums.LevelType.ASSESSMENT_LEVEL)
