...
public class OpenSearchApiService {
   ...
   */
  public OpenSearchApiService(
      @Qualifier("opensearchServiceWebClient") WebClient opensearchServiceWebClient) {
   ...
   * @throws MicroserviceApiException error with specific message when calling opensearch
   *     microservice.
   */
  public void deleteEventsByTrainingInstanceId(Long trainingInstanceId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete events for particular instance (ID: "
              + trainingInstanceId
              + ").",
          ex);
    }
  ...
  public List<AbstractAuditPOJO> findAllEventsFromTrainingDefinition(Long trainingDefinitionId) {
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
              "/training-platform-events/training-definitions/{definitionId}", trainingDefinitionId)
          .retrieve()
          .bodyToMono(new ParameterizedTypeReference<List<AbstractAuditPOJO>>() {})
          .block();
    } catch (CustomWebClientException ex) {
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular definition (ID: "
   ...
   *     microservice.
   */
  public List<AbstractAuditPOJO> findAllEventsFromTrainingInstance(
    ...
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular instance (ID: "
              + trainingInstance.getId()
              + ").",
          ex);
    }
  ...
  public List<AbstractAuditPOJO> findAllEventsFromTrainingRun(TrainingRun trainingRun) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular run (ID: " + trainingRun.getId() + ").",
          ex);
    }
  }
   ...
   *     microservice.
   */
  public Map<Long, Map<Long, List<AbstractAuditPOJO>>> getAggregatedEventsByLevelsAndTrainingRuns(
      Long instanceId) {
    try {
      return opensearchServiceWebClient
          .get()
          ...
          .retrieve()
          .bodyToMono(
              new ParameterizedTypeReference<Map<Long, Map<Long, List<AbstractAuditPOJO>>>>() {})
          .block();
    } catch (CustomWebClientException ex) {
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular instance (ID: " + instanceId + ").",
          ex);
    }
  }
   ...
   *     microservice.
   */
  public Map<Long, Map<Long, List<AbstractAuditPOJO>>> getAggregatedEventsByTrainingRunsAndLevels(
      Long instanceId) {
    try {
      return opensearchServiceWebClient
          .get()
   ...
   *     microservice.
   */
  public Map<Long, List<AbstractAuditPOJO>> getEventsOfTrainingInstanceAndLevelAggregatedByUsers(
      Long instanceId, Long levelId) {
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
              uriBuilder ->
                  uriBuilder
                      .path(
                          "/training-platform-events/training-instances/{instanceId}/levels/{levelId}")
  ...
  public void deleteEventsFromTrainingRun(Long trainingInstanceId, Long trainingRunId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete events for particular training run (ID: "
              + trainingRunId
              + ").",
          ex);
    }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsBySandbox(String sandboxId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular sandbox (ID: " + sandboxId + ").", ex);
    }
  }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserId(
    ...
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
              "/training-platform-commands/access-tokens/{accessToken}/users/{userId}",
              accessToken,
              userId)
          .retrieve()
          .bodyToMono(new ParameterizedTypeReference<List<Map<String, Object>>>() {})
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular training "
              + "(access-token: "
              + accessToken
              + ")"
              + "(user: "
  ...
  public List<Map<String, Object>> findAllConsoleCommandsBySandboxAndTimeRange(
      String sandboxId, Long from, Long to, List<String> filterCommands) {
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
              uriBuilder ->
                  uriBuilder
                      .path("/training-platform-commands/sandboxes/{sandboxId}/ranges")
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular commands of sandbox (ID: "
              + sandboxId
              + ").",
          ex);
    }
  ...
  public List<Map<String, Object>> findAllConsoleCommandsBySandboxAndTimeRange(
      String sandboxId, Long from, Long to) {
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
  ...
  public List<Map<String, Object>> findAllConsoleCommandsByAccessTokenAndUserIdAndTimeRange(
      String accessToken, Long userId, Long from, Long to) {
    try {
      return opensearchServiceWebClient
          .get()
          .uri(
              uriBuilder ->
                  uriBuilder
                      .path(
                          "/training-platform-commands/access-token/{accessToken}/users/{userId}/ranges")
                      .queryParam("from", from)
                      .queryParam("to", to)
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API for particular commands of training "
              + "(access-token: "
              + accessToken
              + ")"
              + "(user: "
  ...
  public void deleteCommandsByPool(Long poolId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete bash commands for particular pool (ID: "
              + poolId
              + ").",
          ex);
    }
  ...
  public void deleteCommandsByAccessToken(String accessToken) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete bash commands for particular training instance (access-token: "
              + accessToken
              + ").",
          ex);
    }
  ...
  public void deleteCommandsBySandbox(String sandboxId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete bash commands for particular sandbox (ID: "
              + sandboxId
              + ").",
          ex);
    }
  ...
  public void deleteCommandsByAccessTokenAndUserId(String accessToken, Long userId) {
    try {
      ...
      throw new MicroserviceApiException(
          "Error when calling OpenSearch API to delete bash commands for particular training (Access Token: "
              + accessToken
              + ", User ID: "
              + userId
              + ").",
