...
@ToString
@ApiModel(
    value = "ReferenceSolutionNodeDTO",
    description = "Definition of the node in the reference graph..")
public class ReferenceSolutionNodeDTO {
  ...
  @ApiModelProperty(
      value = "The list of the states (nodes) that must be reached before this node.",
      required = true,
      example = "20")
  ...
  @ApiModelProperty(
      value = "The command which should be executed during the training.",
      required = true,
      example = "20")
  ...
  @ApiModelProperty(
      value = "The type of the command (bash-command and msf-command are allowed for now).",
      required = true,
      example = "20")
  ...
  @ApiModelProperty(
      value =
          "Regular expression used to determine if execution of the command shift trainee to the node..",
      required = true,
      example = "20")
  ...
  @ApiModelProperty(
      value = "Mark if the node is optional in the training progress. Default is 'false'",
      required = false,
      example = "20")
