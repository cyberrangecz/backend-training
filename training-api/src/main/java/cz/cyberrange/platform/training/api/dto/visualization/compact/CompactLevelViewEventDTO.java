...
@ToString
@ApiModel(
    value = "CompactLevelViewEventDTO",
    description = "Information about a specific event for compact level visualization.")
public class CompactLevelViewEventDTO {
  ...
  @ApiModelProperty(
      ...
      example = "cz.cyberrange.platform.events.trainings.TrainingRunResumed")
  private String type;
