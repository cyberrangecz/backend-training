...
public class TrainingResultsDTO {
  ...
  public int hashCode() {
    return Objects.hash(
        getEstimatedTime(),
        getMaxParticipantScore(),
        getMaxParticipantTrainingScore(),
        getMaxParticipantAssessmentScore(),
        getMaxParticipantTime(),
        getAverageTime(),
        getAverageTrainingScore(),
  ...
  public String toString() {
    return "TrainingResultsDTO{"
        ...
        + ", maxParticipantScore="
        + maxParticipantScore
        + ", maxParticipantTrainingScore="
        + maxParticipantTrainingScore
        + ", maxParticipantAssessmentScore="
        + maxParticipantAssessmentScore
        + ", maxParticipantTime="
        + maxParticipantTime
        + ", averageTime="
