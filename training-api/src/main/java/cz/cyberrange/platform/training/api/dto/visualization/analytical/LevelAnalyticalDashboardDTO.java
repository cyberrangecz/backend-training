...
@NoArgsConstructor
@ApiModel(
    value = "LevelAnalyticalDashboardDTO",
    description = "Analytical dashboard - training level details.")
public class LevelAnalyticalDashboardDTO {
  ...
  @ApiModelProperty(
      value = "Overall number of correctly submitted answers. How many participants solved level.",
      example = "10")
