...
@ApiModel(
    value = "AbstractCommandDTO",
    subTypes = {CommandDTO.class},
    description = "CommandDTO")
@JsonSubTypes({@JsonSubTypes.Type(value = CommandDTO.class, name = "CommandDTO")})
@Data
@AllArgsConstructor
@NoArgsConstructor
public abstract class AbstractCommandDTO {
  ...
  @ApiModelProperty(
      value = "Distinguish tool/command line  in which command ran.",
      required = true,
      example = "BASH")
  @NotEmpty
