...
@ToString
@ApiModel(
    value = "ParticipantLevelAnalyticalDashboardDTO",
    description = "Analytical dashboard - level details of the particular participant.")
public class ParticipantLevelAnalyticalDashboardDTO {
  ...
  @ApiModelProperty(
      value = "Indicates if the participant submitted a wrong answer.",
      example = "true")
