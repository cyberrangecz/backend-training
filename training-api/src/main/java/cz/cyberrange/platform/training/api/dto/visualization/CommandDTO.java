...
@ApiModel(
    ...
    parent = AbstractCommandDTO.class)
...
public class CommandDTO extends AbstractCommandDTO {
  ...
  @NotNull
  @ApiModelProperty(
      value = "Time when command was recorded.",
      required = true,
      example = "2022-07-21T13:16:41.435559")
  @JsonSerialize(using = LocalDateTimeUTCSerializer.class)
  @JsonDeserialize(using = LocalDateTimeUTCDeserializer.class)
  private LocalDateTime timestamp;

  @ApiModelProperty(
      value = "Training time when command was recorded.",
      required = true,
      example = "07:23:43")
  ...
  @NotEmpty
  @ApiModelProperty(
      value = "Ip address where command was submitted.",
      required = true,
      example = "10.10.17.5")
  ...
  @Builder
  public CommandDTO(
      @NotEmpty String commandType,
      @NotEmpty String cmd,
      @Past @NotNull LocalDateTime timestamp,
      @NotNull Duration trainingTime,
      @NotEmpty String fromHostIp,
      @NotEmpty String options) {
