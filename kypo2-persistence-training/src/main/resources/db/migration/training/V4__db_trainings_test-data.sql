...
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Released training definition', null, null, 'RELEASED', 'TrainingDefinition1', 1, true, 1, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Unreleased training definition', null, null, 'UNRELEASED', 'TrainingDefinition2', 2, false, 2, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Released training definition2', null, null, 'RELEASED', 'TrainingDefinition2', 3, true, 3, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - securing connection', null, null, 'RELEASED', 'CTF-1: No Secure Connection', 4, true, 4, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - rigging the election', null, null, 'RELEASED', 'CTF-2: Rigging the Election', 5, true, 5, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - biggest stock scam', null, null, 'RELEASED', 'CTF-3: The Biggest Stock Scam Of All Time', 6, true, 6, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Definition with test assessments', null, null, 'RELEASED', 'TrainingDefinition1', 7, true, 7, '2019-04-17 14:00:00+02');

INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 20, 'Game Level1', 1, 25, 1, 1);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 55, 'Game Level2', 4, 60, 1, 2);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 70, 'Game Level Test', 2, 25, 1, 3);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 70, 'Info Level1', null, 0, 0, 1);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 13, 'Info Level2', 5, 0, 0, 2);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Info Level Test', 3, 0, 0, 3);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 50, 'Assessment Level1', null, 10, 2, 1);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 75, 'Assessment Level2', 6, 10, 2, 2);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 100, 'Assessment Level Test', null, 10, 0, 7);

INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Network Error - Info', null, 0, 1, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 20, 'Network Error', null, 5, 2, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'New Secure Connection - Info', null, 0, 3, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 20, 'New Secure Connection', null, 5, 4, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Unavailable Document - Info', null, 0, 5, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 35, 'Unavailable Document', null, 15, 6, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Disable Passwords - Info', null, 0, 7, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 25, 'Disable Passwords', null, 15, 8, 4);

INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Finding the Vulnerability - Info', null, 0, 1, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 3, 'Finding the Vulnerability', null, 5, 2, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'This Will Not Keep You Out - Info', null, 0, 3, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 5, 'This Will Not Keep You Out', null, 15, 4, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Gaining the Document - Info', null, 0, 5, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 3, 'Gaining the Document', null, 5, 6, 5);

INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Gaining Access - Info', null, 0, 1, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 20, 'Gaining Access', null, 15, 2, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'There Must be Some Vulnerability - Info', null, 0, 3, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 25, 'There Must be Some Vulnerability', null, 15, 4, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Hack This Site - Info', null, 0, 5, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 25, 'Hack This Site', null, 15, 6, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Make Me Root - Info', null, 0, 7, 6);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 30, 'Make Me Root', null, 15, 8, 6);

INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Base info for No Secure Connection', null, 0, 0, 4);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Base info for Rigging the Election', null, 0, 0, 5);
INSERT INTO abstract_level(id, max_score, title, snapshot_hook_id, estimated_duration, order_in_training_definition, training_definition_id) VALUES (nextval('abstract_level_id_seq'), 0, 'Base info for The Biggest Stock Scam Of All Time', null, 0, 0 ,6);
