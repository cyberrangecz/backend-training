...
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Released training definition', null, null, 'RELEASED', 'TrainingDefinition1', 1, 4, true, 1, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Unreleased training definition', null, null, 'UNRELEASED', 'TrainingDefinition2', 2, 5, false, 2, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Released training definition2', null, null, 'RELEASED', 'TrainingDefinition2', 3, 6, true, 3, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - securing connection', null, null, 'RELEASED', 'CTF-1: No Secure Connection', 1, 32, true, 4, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - rigging the election', null, null, 'RELEASED', 'CTF-2: Rigging the Election', null, 33, true,5, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Training definition - biggest stock scam', null, null, 'RELEASED', 'CTF-3: The Biggest Stock Scam Of All Time', null, 34, true, 6, '2019-04-17 14:00:00+02');
INSERT INTO training_definition(id, description, outcomes, prerequisities, state, title, sandbox_definition_ref_id, starting_level, show_stepper_bar, beta_testing_group_id, last_edited) VALUES (nextval('training_definition_id_seq'), 'Definition with test assessments', null, null, 'RELEASED', 'TrainingDefinition1', null, 9, true, 7, '2019-04-17 14:00:00+02');
