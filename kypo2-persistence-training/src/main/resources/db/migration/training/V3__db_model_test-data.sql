INSERT INTO snapshot_hook(id) VALUES (nextval('snapshot_hook_id_seq'));
INSERT INTO snapshot_hook(id) VALUES (nextval('snapshot_hook_id_seq'));
INSERT INTO snapshot_hook(id) VALUES (nextval('snapshot_hook_id_seq'));
INSERT INTO snapshot_hook(id) VALUES (nextval('snapshot_hook_id_seq'));
INSERT INTO snapshot_hook(id) VALUES (nextval('snapshot_hook_id_seq'));
...
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 20, 7, 'Game Level1', 1, 1);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 55, 8, 'Game Level2', 4, 4);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 70, null, 'Game Level Test', 2, 2);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 70, 1, 'Info Level1', 2, 2);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 13, 2, 'Info Level2', 5, 5);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 3, 'Info Level Test', 3, 3);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 50, null, 'Assessment Level1', 3, 3);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 75, null, 'Assessment Level2', 6, 6);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 100, null, 'Assessment Level Test', 1, 1);

INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 11, 'Network Error - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 20, 12, 'Network Error', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 13, 'New Secure Connection - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 20, 14, 'New Secure Connection', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 15, 'Unavailable Document - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 35, 16, 'Unavailable Document', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 17, 'Disable Passwords - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 25, null, 'Disable Passwords', null, null);

INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 19, 'Finding the Vulnerability - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 3, 20, 'Finding the Vulnerability', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 21, 'This Will Not Keep You Out - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 5, 22, 'This Will Not Keep You Out', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 23, 'Gaining the Document - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 3, null, 'Gaining the Document', null, null);

INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 25, 'Gaining Access - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 20, 26, 'Gaining Access', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 27, 'There Must be Some Vulnerability - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 25, 28, 'There Must be Some Vulnerability', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 29, 'Hack This Site - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 25, 30, 'Hack This Site', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 0, 31, 'Make Me Root - Info', null, null);
INSERT INTO abstract_level(id, max_score, next_level, title, snapshot_hook_id) VALUES (nextval('abstract_level_id_seq'), 30, null, 'Make Me Root', null, null);
