...
public class GameLevel extends AbstractLevel implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return solutionPenalty == gameLevel.solutionPenalty && estimatedDuration == gameLevel.estimatedDuration
	...
	public String toString() {
		return "GameLevel{" + "flag='" + flag + '\'' + ", content='" + content + '\'' + ", solution='" + solution + '\'' + ", solutionPenalty="
				+ solutionPenalty + ", estimatedDuration=" + estimatedDuration + ", attachments=" + Arrays.toString(attachments) + ", hints="
				+ hints + ", incorrectFlagLimit=" + incorrectFlagLimit + '}';
	}
}
