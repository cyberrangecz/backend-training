...
public class TrainingDefinitionRepositoryTest {
  ...
  public void FindAllBySandboxDefinitionRefId() {
    ...
    List<TrainingDefinition> trainingDefinitions = trainingDefinitionRepository.findAllBySandBoxDefinitionRefId(sandboxDefinitionRef1.getSandboxDefinitionRef(), pageable).getContent();
