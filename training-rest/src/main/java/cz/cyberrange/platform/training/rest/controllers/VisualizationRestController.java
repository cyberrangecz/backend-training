...
import cz.cyberrange.platform.training.service.facade.AnalyticalDashboardFacade;
import cz.cyberrange.platform.training.service.facade.CompactLevelViewFacade;
import cz.cyberrange.platform.training.service.facade.visualization.AssessmentVisualizationFacade;
...
public class VisualizationRestController {
   ...
   */
  @Autowired
  public VisualizationRestController(
  ...
  /**
   * Gather all necessary information about levels of given training run to visualize results of the
   * training run.
   *
   * @param runId id of training run.
   * @return necessary info about levels for specific training run and additional info about
   *     training definition.
   */
  @ApiOperation(
      httpMethod = "GET",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Visualization info found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
            response = ApiError.class),
        @ApiResponse(
            code = 500,
  ...
  public ResponseEntity<VisualizationInfoDTO> gatherVisualizationInfoForTrainingRun(
      @ApiParam(value = "Training run ID", required = true) @PathVariable("runId") Long runId) {
    VisualizationInfoDTO visualizationInfoAboutTrainingRunDTO =
        visualizationFacade.getVisualizationInfoAboutTrainingRun(runId);
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Commands in training run.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/training-runs/{runId}/commands",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Map<String, Object>>> gatherAllCommandsInTrainingRun(
  ...
  /**
   * Gather all necessary information about levels of given training instance to visualize results
   * of the training instance.
   *
   * @param trainingInstanceId id of training instance.
   * @return necessary info about levels for specific training instance and additional info about
   *     training definition.
   */
  @ApiOperation(
      httpMethod = "GET",
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            code = 404,
            message = "Training instance with given id not found.",
            response = ApiError.class),
        @ApiResponse(
            code = 500,
            message = "Unexpected condition was encountered.",
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<VisualizationInfoDTO> gatherVisualizationInfoForTrainingInstance(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    VisualizationInfoDTO visualizationInfoDTO =
        visualizationFacade.getVisualizationInfoAboutTrainingInstance(trainingInstanceId);
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/participants",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<UserRefDTO>> getParticipantsForGivenTrainingInstance(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    List<UserRefDTO> participants =
        visualizationFacade.getParticipantsForGivenTrainingInstance(trainingInstanceId);
  ...
  public ResponseEntity<Object> getUsersByIds(
      Pageable pageable,
      @ApiParam(value = "usersIds", required = true) @RequestParam Set<Long> usersIds) {
    PageResultResource<UserRefDTO> visualizationInfoDTO =
        visualizationFacade.getUsersByIds(usersIds, pageable);
    return ResponseEntity.ok(SquigglyUtils.stringify(objectMapper, visualizationInfoDTO));
  }

  /**
   * Gather all necessary information for clustering visualization from all instances of the
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Data for visualization found.",
            response = ClusteringVisualizationDTO.class),
        @ApiResponse(
            code = 404,
            message = "Training definition with given id not found.",
            response = ApiError.class),
        @ApiResponse(
            code = 500,
            message = "Unexpected condition was encountered.",
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/clustering",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<ClusteringVisualizationDTO>
      getClusteringVisualizationsForTrainingDefinition(
          @ApiParam(value = "Training definition ID", required = true) @PathVariable("definitionId")
  ...
  public ResponseEntity<ClusteringVisualizationDTO> getClusteringVisualizationsForTrainingInstances(
      @ApiParam(value = "Training instance IDs", required = true)
          @RequestParam(value = "instanceIds", required = true)
          List<Long> instanceIds) {
    ClusteringVisualizationDTO clusteringVisualizationDTO =
        visualizationFacade.getClusteringForTrainingInstances(instanceIds);
    return ResponseEntity.ok(clusteringVisualizationDTO);
  }
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/clustering",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<ClusteringVisualizationDTO> getClusteringVisualizationsForOrganizer(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    ClusteringVisualizationDTO clusteringVisualizationDTO =
        visualizationFacade.getClusteringVisualizationsForOrganizer(trainingInstanceId);
    return ResponseEntity.ok(clusteringVisualizationDTO);
  }
  ...
  @GetMapping(
      path = "/training-runs/{runId}/clustering",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<ClusteringVisualizationDTO> getClusteringVisualizationsForTrainee(
      @ApiParam(value = "Training run ID", required = true) @PathVariable("runId")
          Long trainingRunId) {
    ClusteringVisualizationDTO clusteringVisualizationDTO =
        visualizationFacade.getClusteringVisualizationsForTrainee(trainingRunId);
    return ResponseEntity.ok(clusteringVisualizationDTO);
  }
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/table",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<PlayerDataDTO>> getTableVisualizationsForOrganizer(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    List<PlayerDataDTO> tableVisualizationsDTO =
        visualizationFacade.getTableVisualizationsForOrganizer(trainingInstanceId);
  ...
  public ResponseEntity<List<PlayerDataDTO>> getTableVisualizationsForTrainee(
      @ApiParam(value = "Training run ID", required = true) @PathVariable("runId") Long runId) {
    List<PlayerDataDTO> tableVisualizationsDTO =
        visualizationFacade.getTableVisualizationsForTrainee(runId);
    return ResponseEntity.ok(tableVisualizationsDTO);
  }
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/level-tabs",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<LevelTabsLevelDTO>> getLevelTabsVisualizations(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    List<LevelTabsLevelDTO> levelTabsVisualizationsDTO =
        visualizationFacade.getLevelTabsVisualizations(trainingInstanceId);
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/timeline",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<TimelineDTO> getTimelineVisualizationsForOrganizer(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    TimelineDTO timelineVisualizationDTO =
        visualizationFacade.getTimelineVisualizationsForTrainingInstance(trainingInstanceId);
  ...
  public ResponseEntity<TimelineDTO> getTimelineVisualizationsForTrainee(
      @ApiParam(value = "Training run ID", required = true) @PathVariable("runId") Long runId) {
    TimelineDTO timelineVisualizationDTO =
        visualizationFacade.getTimelineVisualizationsForTrainee(runId);
    return ResponseEntity.ok(timelineVisualizationDTO);
  }
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/progress",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getProgressVisualizations(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long trainingInstanceId) {
    VisualizationProgressDTO visualizationProgressDTO =
        visualizationFacade.getProgressVisualization(trainingInstanceId);
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Data for analytical dashboard found.",
            response = TimelineDTO.class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<TrainingInstanceAnalyticalDashboardDTO>> getAnalyticalDashboard(
      @ApiParam(value = "Training definition ID", required = true) @PathVariable("definitionId")
          Long definitionId) {
    List<TrainingInstanceAnalyticalDashboardDTO> result =
        analyticalDashboardFacade.getDataForAnalyticalDashboard(definitionId);
    return ResponseEntity.ok(result);
  }

  /**
   * Gather all mitre techniques of the training definitions with indication if the definition has
   * been played by user.
   *
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Mitre techniques found.",
            response = TrainingDefinitionMitreTechniquesDTO[].class),
        @ApiResponse(
            code = 404,
            message = "Training instance with given id not found.",
  ...
  @GetMapping(
      path = "/training-definitions/mitre-techniques",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getTrainingDefinitionsWithMitreTechniques() {
    List<TrainingDefinitionMitreTechniquesDTO> trainingDefinitionMitreTechniquesDTOS =
        visualizationFacade.getTrainingDefinitionsWithMitreTechniques();
    return ResponseEntity.ok(
        SquigglyUtils.stringify(objectMapper, trainingDefinitionMitreTechniquesDTOS));
  }
  ...
  @GetMapping(
      path = "/training-instances/{instanceId}/levels/{levelId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  /**
   * Get data for assessment visualizations. Return list of relevant data for each assessment level
   * that can be found in the definition of the particular training instance.
   *
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Data for assessment visualization found.",
            response = AssessmentVisualizationDTO[].class),
        @ApiResponse(
            code = 404,
            message = "Training instance with given id not found.",
  ...
  public ResponseEntity<Object> getAssessmentVisualizations(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long instanceId) {
    List<AssessmentVisualizationDTO> assessmentVisualizationDTOs =
        assessmentVisualizationFacade.getAssessmentVisualizationData(instanceId);
