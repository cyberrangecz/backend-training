...
public class ClusterAnalysisRestController {
   ...
   * @param instanceIds optional list of instance ids (all instances must be from the same
   *     definition)
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "N-dimensional cluster found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/n-dimensional",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Cluster<EuclideanDoublePoint>>> getNDimensionalCluster(
      ...
      @ApiParam(value = "Number of clusters", required = true)
          @RequestParam(value = "numberOfClusters")
          Integer numberOfClusters,
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Cluster<EuclideanDoublePoint>> nDimensionalCluster =
        clusterAnalysisFacade.getNDimensionalCluster(
            definitionId, instanceIds, numberOfClusters, levelId);
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "N-dimensional cluster SSE found.",
            response = Double[].class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/n-dimensional/sse",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Double>> getNDimensionalClusterSSE(
      ...
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Double> nDimensionalClusterSSE =
        clusterAnalysisFacade.getNDimensionalSSE(
            definitionId, instanceIds, numberOfClusters, levelId);
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/hints",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Cluster<HintClusterable>>> getHintCluster(
      ...
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Cluster<HintClusterable>> hintCluster =
        clusterAnalysisFacade.getHintCluster(definitionId, instanceIds, numberOfClusters, levelId);
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/hints/sse",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Double>> getHintClusterSSE(
      ...
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Double> hintClusterSSE =
        clusterAnalysisFacade.getHintClusterSSE(
            definitionId, instanceIds, numberOfClusters, levelId);
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Wrong answers cluster found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/wrong-answers",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Cluster<WrongAnswersClusterable>>> getWrongAnswersCluster(
      ...
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Cluster<WrongAnswersClusterable>> wrongAnswersCluster =
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Wrong answer cluster SSE found.",
            response = Double[].class),
        @ApiResponse(
            code = 404,
            message = "Training run with given id not found.",
  ...
  @GetMapping(
      path = "/training-definitions/{definitionId}/wrong-answers/sse",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<Double>> getWrongAnswersClusterSSE(
      ...
      @ApiParam(value = "Level id", required = false)
          @RequestParam(value = "levelId", required = false)
          Long levelId) {
    List<Double> wrongClusterSSE =
        clusterAnalysisFacade.getWrongAnswersSSE(
            definitionId, instanceIds, numberOfClusters, levelId);
