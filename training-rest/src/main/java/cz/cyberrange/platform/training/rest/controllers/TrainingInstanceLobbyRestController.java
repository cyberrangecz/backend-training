...
public class TrainingInstanceLobbyRestController {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TrainingInstanceLobbyRestController.class);
  ...
  public ResponseEntity<String> getStartDate(
      @ApiParam(value = "Training instance access token", required = true)
          @PathVariable("accessToken")
          String accessToken) {
    return ResponseEntity.ok(teamsManagementFacade.getTrainingInstanceStartDate(accessToken));
  }
  ...
  public ResponseEntity<TeamDTO> getTeamInfo(
      @ApiParam(value = "Training instance access token", required = true)
          @PathVariable("accessToken")
          String accessToken) {
    return ResponseEntity.ok(teamsManagementFacade.getTeamInfo(accessToken));
  }
  ...
  public ResponseEntity<TrainingInstanceLobbyDTO> getInstanceLobby(
    ...
    return ResponseEntity.ok(teamsManagementFacade.getTrainingInstanceLobby(instanceId));
  }
  ...
  public ResponseEntity<TeamDTO> createTeam(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long instanceId,
      @ApiParam(value = "New team name", required = true) @RequestParam("name") String name) {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            code = 404,
            message = "Team with given id not found.",
            response = ApiError.class),
        @ApiResponse(
            code = 409,
  ...
  public ResponseEntity<String> renameTeam(
      ...
      @ApiParam(value = "New name", required = true) @RequestParam("name") String name) {
  ...
  public ResponseEntity<Void> disbandTeam(
      @ApiParam(value = "New team name", required = true) @PathVariable("teamId") Long teamId) {
  ...
  public ResponseEntity<Void> transferPlayersBetweenTeams(
      @ApiParam(value = "Team to transfer players from", required = true) @RequestParam("from")
          Long idFrom,
      @ApiParam(value = "Team to transfer players to", required = true) @RequestParam("to")
          Long idTo,
      @ApiParam(value = "Player ids transferred", required = true) @RequestBody
          Set<Long> playerIds) {
  ...
  public ResponseEntity<Void> transferPlayersToTeams(
      @ApiParam(value = "Training instance ID", required = true) @PathVariable("instanceId")
          Long instanceId,
      @ApiParam(value = "Player ids to transfer", required = true) @RequestBody
