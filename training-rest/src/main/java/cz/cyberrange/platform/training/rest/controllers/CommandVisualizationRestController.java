...
public class CommandVisualizationRestController {
   ...
   * @return graph that represents the recommended execution of the commands during the levels and
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Reference graph found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Reference graph for the given training definition not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/graphs/reference/training-definitions/{definitionId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getReferenceGraphForDesigner(
    ...
    return ResponseEntity.ok(
        commandVisualizationFacade.getReferenceGraphByDefinitionId(definitionId));
  }
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            code = 404,
            message = "Reference graph for the given training instance not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/graphs/reference/training-instances/{instanceId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            code = 404,
            message = "Reference graph for the given training run not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/graphs/reference/training-runs/{runId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
   ...
   *
   * @param instanceId ID of training instance.
   * @return graph that represents the summarized command execution of the trainees during the
   *     training.
   */
  @ApiOperation(
      httpMethod = "GET",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            code = 200,
            message = "Summary graph found.",
            response = VisualizationInfoDTO.class),
        @ApiResponse(
            code = 404,
            message = "Summary graph for the given training instance not found.",
            response = ApiError.class)
      })
  @GetMapping(
      path = "/graphs/summary/training-instances/{instanceId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getSummaryGraph(
      @ApiParam(value = "Training definition ID", required = true) @PathVariable("instanceId")
          Long instanceId) {
  ...
  @GetMapping(
      path = "/graphs/trainee/training-runs/{runId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> getTraineeGraph(
      @ApiParam(value = "Training definition ID", required = true) @PathVariable("runId")
          Long runId) {
