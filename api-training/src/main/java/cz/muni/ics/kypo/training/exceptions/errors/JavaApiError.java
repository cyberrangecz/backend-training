...
public class JavaApiError extends ApiSubError {
    ...
    @ApiModelProperty(value = "The requested URI path which caused error.", example = "/kypo-rest-user-and-group/api/v1/groups/1000 (different for each type of exception).")
    private String path;
